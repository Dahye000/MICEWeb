...
<body>
	...
	<main>
		<div class="main">
			<div class="category_n_recommend">
				<div class="category">
				</div>
				<div class="recommend">
					<img src="banner.png" style="max-width:100%; height: 100%;">
				</div>
			</div>
			<div class="recommend_product">
				<div class="text" style="text-align:center; margin:40px;">
					추천 상품
				</div>
